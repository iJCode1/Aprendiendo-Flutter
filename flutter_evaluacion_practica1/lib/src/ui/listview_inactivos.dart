...
class ListViewInactivos extends StatefulWidget {
  ListViewInactivos({Key? key}) : super(key: key);
  _ListViewInactivosState createState() => _ListViewInactivosState();
}

final pastelRF = FirebaseDatabase.instance.reference().child('pastel').orderByChild("status").equalTo("Inactivo");
class _ListViewInactivosState extends State<ListViewInactivos> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      title: 'Lista de Pasteles Inactivos',
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Lista de Pasteles Inactivos", style: TextStyle(fontSize: 19),),
                                        ...
                                        child: Row(
                                          children: <Widget>[
                                            ...
                                            RaisedButton(
                                                ...
                                                showDialog(
                                                  ...
                                                  builder: (BuildContext context){
                                                    return AlertDialog(
                                                      title: Column(
                                                        children: [
                                                          Text('Confirmar Activación', style: TextStyle(fontFamily: "Lato", fontSize: 25, color: Colors.black),),
                                                          Padding(padding: EdgeInsets.only(top: 10, bottom: 20)),
                                                          Image.network('https://firebasestorage.googleapis.com/v0/b/flutter-evaluacion-practica1.appspot.com/o/imagenes%2Ficon_success.png?alt=media&token=2aac6c4f-165d-47bd-b66c-1c930dc154fa',
                                                      ...
                                                      content: SingleChildScrollView(
                                                        child: ListBody(
                                                          children: [
                                                            Center(child: Text('¿Activar Pastel?', style: TextStyle(fontFamily: "Lato", fontWeight: FontWeight.w700, fontSize: 20, color: Colors.green[300]),)),
                                                          ],
                                                        ),
                                                      ),
                                                      actions: [
                                              ...
                                              color: Color.fromRGBO(175, 200, 70, 1.0)
                                            ),
                                            SizedBox(
                                              width: 2.0,
                                            ),
